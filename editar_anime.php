...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            $mensaje = "Anime actualizado exitosamente";
            
            // Recargar los datos del anime después de la actualización
            $anime = cargarDatosAnime($conn, $anime_id);
        } else {
...
<body>
    ...
    <?php endif; ?>
    <form action="editar_anime.php?id=<?php echo $anime_id; ?>" method="post" enctype="multipart/form-data">
